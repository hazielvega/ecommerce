            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div class="bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-700 sticky top-8">
                    <div class="p-6 lg:p-8">
                        ...
                        <button onclick="VisanetCheckout.open()"
                            class="mt-8 w-full bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-white font-bold py-4 px-6 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center space-x-3">
                        ...
                        @if (session('niubiz'))
                            ...
                            @isset($response['data'])
                                <div class="mt-6 p-4 text-sm text-red-400 rounded-lg bg-red-900/30 border border-red-800"
                                    role="alert">
                                    ...
                                    <button class="mt-3 text-sm text-red-400 hover:text-red-300 font-medium">
